...
class UI {
    ...
    void menu() {
        ...
        println "10. Cadastrar nova vaga"
        println "11. Atualizar dados de vaga"
        println "12. Deletar vaga"
        println "\nCompetencias "
        println "13. Listar todas competências"
        println "14. Cadastrar nova competência"
        println "15. Cadastrar uma lista de competência"
        println "16. Atualizar dados de competência"
        println "17. Deletar competência"
        println "0. Sair"
        println "============================================================"
